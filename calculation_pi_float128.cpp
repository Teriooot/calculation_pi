...
void calculation_pi(__float128 n, uint32_t amount_threads, __float128* out)
{
	__float128 result = 1;
	...
	for (__float128 i = 1; i <= n / 2; i++)
	{
		result -= (__float128)2 / (16 * i * i - 1);
	}
	if (fmodq(n, 2) == 1)
	{
		cout << "ODD" << endl; //убрать

		result -= (__float128)1 / n;
	}
	result *= 4;
